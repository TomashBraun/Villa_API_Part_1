...
namespace Villa_API.Migrations
{
    ...
    [Migration("20231229144258_FirstStart")]
            ...
            modelBuilder.Entity("Villa_API.Models.Villa.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 16, 42, 58, 640, DateTimeKind.Local).AddTicks(9848),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 16, 42, 58, 640, DateTimeKind.Local).AddTicks(9891),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 16, 42, 58, 640, DateTimeKind.Local).AddTicks(9894),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 16, 42, 58, 640, DateTimeKind.Local).AddTicks(9896),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 16, 42, 58, 640, DateTimeKind.Local).AddTicks(9899),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
