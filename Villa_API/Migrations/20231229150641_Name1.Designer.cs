...
namespace Villa_API.Migrations
{
    ...
    [Migration("20231229150641_Name1")]
    partial class Name1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Villa_API.Models.Villa.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 17, 6, 41, 420, DateTimeKind.Local).AddTicks(366),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 17, 6, 41, 420, DateTimeKind.Local).AddTicks(410),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 17, 6, 41, 420, DateTimeKind.Local).AddTicks(413),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 17, 6, 41, 420, DateTimeKind.Local).AddTicks(415),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 12, 29, 17, 6, 41, 420, DateTimeKind.Local).AddTicks(418),
                            Details = "Похоже, что у вас возникает проблема с SSL-сертификатом при подключении к серверу базы данных. В вашей строке подключения к базе данных отсутствует указание на использование SSL. Попробуйте добавить параметр Encrypt=True в вашу строку подключения:",
